              ...
              {mapConfigs.map((config, index) => (
                <Box key={config.id} className={styles["map-item"]}>
                  <Box className={styles["map-item-header"]}>
                    <Typography
                      variant="body2"
                      className={styles["map-item-title"]}
                    >
                        ...
                        <FormControl size="small" fullWidth>
                          ...
                          >
                            ...
                            {dataset &&
                              ...
                              Object.keys(
                                dataset[config.dataset].columnThresholds || {}
                              ).map((metricName) => (
          ...
          <Stack spacing={2} className={styles["section-content"]}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Dataset"
                onChange={(event) =>
                  onDatasetChange(event.target.value as string)
                }
              >
                <MenuItem value="">
                  <em>Select Dataset</em>
            ...
            {activeDataset && (
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Metric"
                  onChange={(event) =>
                    onMetricChange(event.target.value as string)
                  }
                >
                  <MenuItem value="">
                    <em>Select Metric</em>
