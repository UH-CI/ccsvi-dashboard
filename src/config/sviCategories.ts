    ...
    indicators: [
      {
        ...
        description: "Share of housing units built before 1990. Older housing stock can be less resilient to hazards and indicate higher displacement risk and maintenance burden for households.",
      },
      ...
      { dataset: "tenure", metric: "Renter occupied", label: "Renter occupied units", description: "Share or count of housing units occupied by renters. Renters often have less control over mitigation measures and may face greater displacement risk after events." },
    ],
  },
  {
    ...
    indicators: [
      ...
      },
      {
        ...
        description: "Percentage of population with income below 150% of the federal poverty level. This broader threshold highlights households with constrained resources who remain vulnerable to shocks.",
      },
      {
        dataset: "income_share_of_fpl",
    ...
    indicators: [
      {
        ...
        description: "Count or share of male children aged 0–5. Young children have specific caregiving and evacuation needs and increase household vulnerability.",
      },
      {
        dataset: "person_under_5_65_females",
        metric: "Females Under 5 (calc.)",
        label: "Aged 5 years and under (female)",
        description: "Count or share of female children aged 0–5. Young children have caregiving and evacuation needs that affect household coping capacity.",
      },
      {
        dataset: "person_under_5_65_males",
        metric: "Males Under 18 (calc.)",
        label: "Aged 17 years and under (male)",
        description: "Count or share of male children and adolescents under 18. Larger youth populations influence evacuation planning and caregiving resource needs.",
      },
      {
        dataset: "person_under_5_65_females",
        metric: "Females Under 18 (calc.)",
        label: "Aged 17 years and under (female)",
        description: "Count or share of female children and adolescents under 18. These households may require child-focused support during emergencies.",
      },
      {
        dataset: "person_under_5_65_males",
        metric: "Males Over 65 (calc.)",
        label: "Aged 65 years and older (male)",
        description: "Count or share of older male adults (65+). Older adults often have mobility, health, and social care needs that affect resilience and evacuation.",
      },
      {
        dataset: "person_under_5_65_females",
        metric: "Females Over 65 (calc.)",
        label: "Aged 65 years and older (female)",
        description: "Count or share of older female adults (65+). Older adults often have mobility, health, and social care needs that affect resilience and evacuation.",
      },
      {
        dataset: "living_arrangements",
        metric: "Total Living alone (calc.)",
        label: "Living alone",
        description: "Share or count of people living alone. Single-occupant households may have reduced social support and face higher isolation during hazards.",
      },
      {
        dataset: "living_arrangements",
        metric: "In households: Householder: Male: Living alone",
        label: "Living alone (male)",
        description: "Count or share of male householders living alone. Gendered patterns of living alone can inform social outreach and sheltering needs.",
      },
      {
        dataset: "living_arrangements",
        metric: "In households: Householder: Female: Living alone",
        label: "Living alone (female)",
        description: "Count or share of female householders living alone. These households may have specific social support and safety needs during emergencies.",
      },
      {
        ...
        description: "Count or share of children under 5 living on Hawaiian homelands. Highlights young populations in culturally specific land contexts that affect preparedness and response.",
      },
      {
        dataset: "2022_census_hawaiian_homelands",
        metric: "Total Population Under 18 (calc.)",
        label: "Hawaiian homelands - aged 17 years and under",
        description: "Count or share of people under 18 living on Hawaiian homelands. Useful for planning youth-centered communication and services in these communities.",
      },
      {
        dataset: "2022_census_hawaiian_homelands",
        metric: "Total Population Over 65 (calc.)",
        label: "Hawaiian homelands - aged 65 years and older",
        description: "Count or share of older adults living on Hawaiian homelands. Identifies elders who may have specific health, mobility, and cultural needs during emergencies.",
      },
    ],
  },
  {
    ...
    indicators: [
      { dataset: "race_origin", metric: "White alone", label: "White population", description: "Population identifying as White. Racial composition contextualizes structural exposure and access to resources across places." },
      {
        dataset: "race_origin",
      ...
      { dataset: "race_origin", metric: "Two or More Races", label: "Two or More Races", description: "Population identifying with two or more races. Multiracial composition can reflect diverse social networks and mixed access to resources." },
      {
        ...
        description: "Share or count of households with limited English proficiency. Language barriers can reduce access to warnings, assistance, and recovery information.",
      },
      {
        dataset: "limited_english_speaking",
